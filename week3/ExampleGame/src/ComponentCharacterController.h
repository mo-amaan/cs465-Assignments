...
namespace week2
{
	...
	public:
		...
		void RegisterWalkingDelegate(std::function<void (int testParam)> p_fFunction)		{ m_fWalkingDelegate = p_fFunction; }
		void RegisterStopWalkingDelegate(std::function<void (int testParam)> p_fFunction)	{ m_fStopWalkingDelegate = p_fFunction; }
	...
	private:
		...
		// Delegates for StartWalking and StopWalking
		std::function<void (int testParam)> m_fWalkingDelegate;
		std::function<void (int testParam)> m_fStopWalkingDelegate;
